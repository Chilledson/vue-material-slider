(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-material-slider"] = factory();
	else
		root["vue-material-slider"] = factory();
...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slider_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony default export */ var slidervue_type_script_lang_js_ = ({
  ...
  methods: (_methods = {
    ...
    _onSlide: function _onSlide(event) {
      if (this.disabled) {
        return;
      }
    ...
    _onSlideStart: function _onSlideStart(event) {
    ...
    _onSlideEnd: function _onSlideEnd() {
      this.isSliding = false;
  ...
  }, _defineProperty(_methods, "_onKeydown", function _onKeydown(event) {
    if (this.disabled) {
      return;
    }
    ...
    this._isSliding = true;
    event.preventDefault();
  }), _defineProperty(_methods, "_onKeyup", function _onKeyup() {
    this._isSliding = false;
  }), _defineProperty(_methods, "_increment", function _increment(numSteps) {
    this.val = this._clamp((this.val || 0) + this.step * numSteps, this.curMin, this.curMax);
  }), _defineProperty(_methods, "_getSliderDimensions", function _getSliderDimensions() {
    return this.$refs.slider ? this.$refs.slider.getBoundingClientRect() : null;
  }), _defineProperty(_methods, "_clamp", function _clamp(value) {
    var min = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    var max = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    return Math.max(min, Math.min(value, max));
  }), _defineProperty(_methods, "_onBlur", function _onBlur() {
    this.isActive = false;
  }), _defineProperty(_methods, "_focusHostElement", function _focusHostElement() {
    this.isActive = true;
    this.$refs.slider.focus();
  }), _defineProperty(_methods, "_calculateValue", function _calculateValue(percentage) {
    return this.curMin + percentage * (this.curMax - this.curMin);
  }), _defineProperty(_methods, "_calculatePercentage", function _calculatePercentage(value) {
    return ((value || 0) - this.curMin) / (this.curMax - this.curMin);
  }), _defineProperty(_methods, "_emitInputEvent", function _emitInputEvent() {
    this.$emit("input", this.val);
  }), _defineProperty(_methods, "_emitChangeEvent", function _emitChangeEvent() {
    this.$emit("change", this.val);
  }), _defineProperty(_methods, "_getDirection", function _getDirection() {
    return this.$data._dir == "rtl" ? "rtl" : "ltr";
  }), _defineProperty(_methods, "_shouldInvertMouseCoords", function _shouldInvertMouseCoords() {
...
var slidervue_type_style_index_0_lang_css_ = __webpack_require__("c7d4");
